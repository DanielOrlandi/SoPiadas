...
namespace SoPiadas.Controllers
{
    public class PiadasController : Controller
    {
        ...
        // GET: Piadas/ProcurarPlanilhaPiada
        public IActionResult ProcurarPlanilhaPiada()
        {
            return View();
        }

        // PoST: Piadas/MostrarResultados
        public async Task<IActionResult> MostrarResultados(string ProcurarFrases)
        {
            return View("Index", await _context.Piada.Where( j => j.Pergunta.Contains(ProcurarFrases)).ToListAsync());
        }
